...
// The next block of code was simply with Headless Pattern under ***agnostic Entity*** concept
...
const productSchema = [
  ...
  export const ProductTable = () => <GenericTable schema={productSchema} data={productData} rowKey="id" />;